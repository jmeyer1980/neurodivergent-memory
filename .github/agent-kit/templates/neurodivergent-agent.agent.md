...
tools: [read, edit, execute, search, agent, web, browser, vscode/*, github/*, neurodivergent-memory/*, gitkraken/*, pylance-mcp-server/*, github.vscode-pull-request-github/*, ms-azuretools.vscode-containers/*, ms-python.python/*, todo]
user-invocable: true
---
...
- **DO NOT** gate memory writes on tags — canonical tags (`topic:X`, `scope:X`, `kind:X`, `layer:X`) improve retrieval, but a content-only `store_memory` is valid. Add tags when they materially help future search.
