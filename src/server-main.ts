...
export function runInitAgentKit(argv: string[]): number {
...
export const PERSISTENCE_FILE = PERSISTENCE_LOCATION.file;
        ...
        inputSchema: {
          ...
          properties: {
            entries: {
              ...
              description: "Array of memory entries to import. Required if file_path is not provided."
            },
            file_path: {
              type: "string",
